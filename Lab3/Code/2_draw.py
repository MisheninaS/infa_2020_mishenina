...
def cattus(a, b, c, furcolor, eyecolor):
    ...
    polygon(screen, (250, 128, 114), [(a + 18.75*c, b + 34.375*c), (a + 31.25*c, b + 34.375*c), (a + 25*c, b + 40.625*c)])
    polygon(screen, (0, 0, 0), [(a + 18.75*c, b + 34.375*c), (a + 31.25*c, b + 34.375*c), (a + 25*c, b + 40.625*c)], 1)
    line(screen, (0, 0, 0), (a + 25*c, b + 46.875*c), (a + 25*c, b + 40.625*c), 1)
    
    arc(screen, (0, 0, 0), (a + 12.5*c, b + 40.625*c, 12.5*c, 12.5*c), -1.57, 0)
